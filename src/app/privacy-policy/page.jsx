    ...
    return(
        <div className={styles.privacy_policy}>            
            ...
            <ul>
                ...
                <li>Mengisi formulir konsultasi atau feedback,</li>
            ...
            <ul>
                ...
                <li>📍 Alamat: 23/F Penhouse, Jl. Jenderal Sudirman No. Kav.76-78, Marein Plaza, Kuningan, Jakarta 12910</li>
                <li>📞 WhatsApp: (+62) 877 4052 1777</li>
            </ul>
        </div>
    )
}