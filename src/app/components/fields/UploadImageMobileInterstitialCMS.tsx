...
interface UploadImageMobileInterstitialCMSProps {
...
export default function UploadImageMobileInterstitialCMS(
  ...
  return (
    <div className="upload-file-container flex flex-col gap-1">
      <div
        className="upload-photo-container flex relative aspect-interstitial-banner bg-white w-full h-full border border-dashed border-outline cursor-pointer rounded-md overflow-hidden"
          ...
          <div className="upload-helper flex flex-col w-full font-bodycopy items-center text-center justify-center text-black z-10">
            ...
            <div className="flex flex-col max-w-[300px]">
              ...
              <p className="text-sm font-medium text-black/50">
                Upload a 720x1280 px image and keep it under 500 KB
              </p>
            </div>
          </div>
        )}
