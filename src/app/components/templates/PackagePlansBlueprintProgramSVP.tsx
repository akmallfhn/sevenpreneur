...
export default function PackagePlansBlueprintProgramSVP({
  ...
  return (
    <div className="root relative flex items-center justify-center bg-black overflow-hidden">
      <div className="container flex flex-col w-full items-center p-5 py-10 pb-24 gap-8 z-10 lg:px-0 lg:gap-[64px] lg:py-[60px] lg:max-w-[988px] xl:max-w-[1208px] 2xl:max-w-[1300px]">
        {/* Section Title & Desc */}
        <div className="section-title-desc flex flex-col w-full text-center items-center gap-3 z-10">
          ...
          <p className="section-desc text-sm font-bodycopy text-white max-w-[326px] lg:text-xl lg:max-w-[712px]">
            Dua paket sesuai kebutuhanmu. Pilih Reguler untuk pelajari kurikulum
            7 Framework lengkap, atau naik ke VIP untuk pengalaman eksklusif dan
            manfaat premium.
          </p>
        </div>
          ...
          {cohortPrices
            ...
            .map((post, index) => (
              <PackageItemBlueprintProgramSVP
                ...
                packageId={post.id}
                packageName="Batch 7"
                packageLabel={<PackageLabelBlueprintProgramSVP variant="vip" />}
