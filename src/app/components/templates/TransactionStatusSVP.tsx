...
export default function TransactionStatusSVP() {
  return (
    <React.Fragment>
      <div className="transaction-page relative flex flex-col pb-36 gap-1 bg-[#F9F9F9]">
        {/* Transaction Status */}
        <div className="transaction-status flex flex-col items-center gap-5 bg-white p-5">
        ...
        {/* Payment Method */}
        <div className="payment flex flex-col gap-4 bg-white p-5">
        ...
        <div className="transaction-metadata flex flex-col gap-1 bg-white p-5">
          <ReceiptLineItemSVP
        ...
        {/* Support Helpdesk */}
        <div className="support-helpdesk flex gap-1 bg-white py-4 p-5 items-center justify-between">
        ...
        {/* CTA */}
        <div className="flex flex-col p-5 pt-8 gap-3">
          <AppButton size="defaultRounded">Continue Payment</AppButton>
          <AppButton variant="semiDestructive" size="defaultRounded">
            Cancel Order
          </AppButton>
        </div>
      </div>
