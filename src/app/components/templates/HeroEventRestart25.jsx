...
export default function HeroEventRestart2025() {
    return(
        <div className="relative pb-10 pt-64 gap-5 flex flex-col items-center w-full bg-[#020203] overflow-hidden lg:pt-[542px]">
            ...
            {/* --- Overlay */}
            <div className={`overlay absolute left-1/2 -translate-x-1/2 top-58 w-[800px] h-[502px] z-40 bg-[#3417E3] rounded-full blur-2xl lg:w-[1752px] lg:h-[1058px] lg:top-[480px]`}/>
            ...
            src={"https://static.wixstatic.com/shapes/02a5b1_8a2fc0c9c99a4bc8a4366aab12450a53.svg"}
            alt="Background Hero"
            width={2440}
            height={2440}/>
