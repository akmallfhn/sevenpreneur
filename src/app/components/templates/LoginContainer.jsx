        ...
        <div className="container flex z-30 py-14 px-6 max-w-[336px] items-center bg-white/30 rounded-[20px] backdrop-blur-xl lg:max-w-[420px]">
            <div className="login-component flex flex-col mx-auto gap-8 text-white items-center text-center lg:text-black">
                ...
                <div className="login-head flex flex-col font-ui gap-2">
                    <h1 className="login-title text-xl font-black lg:text-2xl">
                        Welcome Back, Founder!
                    </h1>
                    <p className="login-tagline font-medium lg:text-lg lg:text-alternative">
                        Log in. Level up. Scale.
                    </p>
                </div>
                <div className="login-action flex flex-col font-ui gap-2 w-full">
                    <p className="text-xs lg:text-base lg:text-alternative">
                        Login faster with
                    </p>
                ...
                <p className="font-ui text-[10px] lg:text-sm">
                    By logging in, you agree to Sevenpreneur’s {""}
                    <Link href={"/privacy-policy"} className="font-black text-secondary underline" target="_blank" rel="noopener noreferrer">
                        Privacy Policy
                    </Link>
                    {""} and {""}
                    <Link href={"/terms-condition"} className="font-black text-secondary underline" target="_blank" rel="noopener noreferrer">
                        Terms & Conditions
                    </Link>                     
                </p>
            </div>
