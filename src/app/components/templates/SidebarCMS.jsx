...
import { CircleHelp, CircleUserIcon, DoorOpen, GraduationCap, HouseIcon } from "lucide-react"
            ...
            <div className="sidebar-cms-top flex flex-col max-w-[224px] w-full mx-auto gap-[22px]">
                ...
                <div className="platform-and-logo flex w-full items-center gap-4">
                    ...
                    <div className="platform max-w-[132px]">
                        <p className="font-brand font-bold">
                            Sevenpreneur
                        </p>
                        <p className="font-brand text-xs">
                ...
                <Link href={"/"} className="user-roles-container flex w-full p-2 items-center gap-3 bg-white border border-[#E3E3E3] rounded-lg">
                    ...
                    <div className="user-roles flex flex-col font-brand gap-0">
                        <p className="user text-sm font-semibold">
                            Aulia Askha
                        </p>
