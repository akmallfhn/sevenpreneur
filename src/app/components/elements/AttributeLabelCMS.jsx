"use client"
import { faBuildingUser, faChalkboardTeacher, faChalkboardUser, faPenNib, faUser } from "@fortawesome/free-solid-svg-icons";
...
export default function AttributeLabelCMS({ labelName, variants }) {
    ...
    return(
        <div className={`label-container inline-flex py-0.5 px-2 rounded-md items-center justify-center gap-1 text-xs font-semibold font-bodycopy truncate ${labelColor} ${backgroundColor}`}>
            {labelIcon}
            {labelName}
        </div>
    )
