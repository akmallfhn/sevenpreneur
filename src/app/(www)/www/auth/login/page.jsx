...
export const metadata = {
    ...
    description: "Akses platform eksklusif yang dirancang untuk bertumbuh bersama dan wujudkan bisnis terbaikmu. Login sekarang dan lanjutkan.",
    keywords: "Sevenpreneur, login, akses akun, platform bisnis, wirausaha digital, manajemen usaha, growth platform",
...
export default function AuthPage() {
    return(
        <div className={`root fixed top-0 left-0 w-screen h-screen justify-center z-50 transition-all duration-700 ease-in-out`}>
                ...
                <div className="absolute flex inset-0 lg:relative lg:flex-1/2">
                    ...
                    <div className="quotes hidden lg:flex lg:absolute lg:w-max lg:top-1/2 lg:-translate-y-1/2 lg:left-1/2 lg:-translate-x-1/2">
                        <p className="p-2 text-center text-4xl font-brand font-bold text-transparent bg-clip-text bg-gradient-to-br from-0% from-white/90 to-[140%] to-[#3417E3]">
                            Tools for <span className="font-bodycopy italic underline decoration-[#7463DF]">scaling</span><br/>
                            Frameworks for <span className="font-bodycopy italic underline decoration-[#7463DF]">thinking</span><br/>
                            Space for <span className="font-bodycopy italic underline decoration-[#7463DF]">becoming</span>
                        </p>
                    </div>
                    {/* Background */}
                    <Image
